...
namespace MvcRWV2.Data
{
    ...
    public static class DbInitializer
    {
        public static void Initialize(ApplicationDbContext context)
        {
            ...
            var tag = new Tag[]
            {
            new Tag{Nama="Test", Tanggal= DateTime.Now}
            };

            foreach (Tag a in tag)
            {
                context.DaftarTag.Add(a);
            }
            context.SaveChanges();
             ...
             * Path Artikel 
             */
            var myFilesArtikel = Directory.GetFiles("wwwroot/pdf/artikel/", "*.*", SearchOption.AllDirectories).Where(s => extPdf.Contains(Path.GetExtension(s)));
             ...
             * Path Infografis 
             */
            var myFilesInfografis = Directory.GetFiles("wwwroot/pdf/infografis/", "*.*", SearchOption.AllDirectories).Where(s => extPdf.Contains(Path.GetExtension(s)));
            ...
            foreach (PathArtikel s in pathArtikel)
            {
                ...
                artikel.Add(new Artikel { Judul = JudulString, Tanggal = DateTime.Now, Path = s, Status = 1,Penulis="admin" });
            }
            ...
            foreach (PathBuku s in pathBuku)
            {
                string MyString = s.Path.ToString();
                string JudulString = MyString.Replace(".pdf", "");
                buku.Add(new Buku { Judul = JudulString, PenulisBuku = "", Terbitan = "", ISBN = "", Deskripsi ="", Tebal = 1, Tanggal = DateTime.Now, Path = s, Status = 1, Penulis = "admin" });
            }
            ...
            foreach (PathKonsultasiInfografis s in pathInfografis)
            {
                string MyString = s.Path.ToString();
                string JudulString = MyString.Replace(".pdf", "");
                infografis.Add(new KonsultasiInfografis { Judul = JudulString, Tanggal = DateTime.Now, Path = s, Status = 1, Penulis = "admin" });
            }
            ...
            {
                new KajianAudio{ Link = "https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/357475985&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true", Tanggal = DateTime.Now, Status = 1,Penulis="admin" },
                new KajianAudio{ Link = "https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/268727142&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true", Tanggal = DateTime.Now, Status = 1,Penulis="admin" },
                new KajianAudio{ Link = "https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/playlists/224844275&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true", Tanggal = DateTime.Now, Status = 1,Penulis="admin" },
                new KajianAudio{ Link = "https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/292675007&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true", Tanggal = DateTime.Now, Status = 1,Penulis="admin" },
                new KajianAudio{ Link = "https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/playlists/224844275&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true", Tanggal = DateTime.Now , Status = 1,Penulis="admin"},
                new KajianAudio{ Link = "https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/212773651&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true", Tanggal = DateTime.Now, Status = 1,Penulis="admin" },
                new KajianAudio{ Link = "https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/413160264&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true", Tanggal = DateTime.Now, Status = 1,Penulis="admin" },
                new KajianAudio{ Link = "https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/196296200&color=%23ff5500&auto_play=false&hide_related=false&show_comments=true&show_user=true&show_reposts=false&show_teaser=true", Tanggal = DateTime.Now, Status = 1,Penulis="admin" }
            };
            ...
            {
                new KajianVideo{ Link = "https://www.youtube.com/embed/NhCwuonQaMA", Tanggal = DateTime.Now, Status = 1,Penulis="admin" },
                new KajianVideo{ Link = "https://www.youtube.com/embed/INK1IvY4WSA", Tanggal = DateTime.Now, Status = 1,Penulis="admin" },
                new KajianVideo{ Link = "https://www.youtube.com/embed/HXOy6M8Vedk", Tanggal = DateTime.Now, Status = 1,Penulis="admin" },
                new KajianVideo{ Link = "https://www.youtube.com/embed/8bPY1JfdHoo", Tanggal = DateTime.Now, Status = 1,Penulis="admin" },
                new KajianVideo{ Link = "https://www.youtube.com/embed/RUaYn6sogWA", Tanggal = DateTime.Now, Status = 1,Penulis="admin" },
                new KajianVideo{ Link = "https://www.youtube.com/embed/veSwehsY0-Q", Tanggal = DateTime.Now, Status = 1,Penulis="admin" },
                new KajianVideo{ Link = "https://www.youtube.com/embed/cVsrwXnQytM", Tanggal = DateTime.Now, Status = 1,Penulis="admin" },
                new KajianVideo{ Link = "https://www.youtube.com/embed/qggLZOQS87U", Tanggal = DateTime.Now, Status = 1,Penulis="admin" },
                new KajianVideo{ Link = "https://www.youtube.com/embed/Rqe8OWIOm0w", Tanggal = DateTime.Now, Status = 1,Penulis="admin" },
                new KajianVideo{ Link = "https://www.youtube.com/embed/tRlsZGYqc14", Tanggal = DateTime.Now, Status = 1,Penulis="admin" },
                new KajianVideo{ Link = "https://www.youtube.com/embed/qtV6syQ6gAY", Tanggal = DateTime.Now, Status = 1,Penulis="admin" },
                new KajianVideo{ Link = "https://www.youtube.com/embed/8BrivQ_Qgm4", Tanggal = DateTime.Now, Status = 1,Penulis="admin" },
                new KajianVideo{ Link = "https://www.youtube.com/embed/JckLDRJ1VSE", Tanggal = DateTime.Now, Status = 1,Penulis="admin" },
                new KajianVideo{ Link = "https://www.youtube.com/embed/dZeLwE_1pao", Tanggal = DateTime.Now, Status = 1,Penulis="admin" },
                new KajianVideo{ Link = "https://www.youtube.com/embed/N2sE_WJJeHM", Tanggal = DateTime.Now, Status = 1,Penulis="admin" },
                new KajianVideo{ Link = "https://www.youtube.com/embed/7_TO7NfwVsE", Tanggal = DateTime.Now, Status = 1,Penulis="admin" },
                new KajianVideo{ Link = "https://www.youtube.com/embed/083V4Njtmsk", Tanggal = DateTime.Now, Status = 1,Penulis="admin" },
                new KajianVideo{ Link = "https://www.youtube.com/embed/5rcYyusDdHk", Tanggal = DateTime.Now, Status = 1,Penulis="admin" },
                new KajianVideo{ Link = "https://www.youtube.com/embed/ASg2un67amU", Tanggal = DateTime.Now, Status = 1,Penulis="admin" },
                new KajianVideo{ Link = "https://www.youtube.com/embed/AxSr716O0rE", Tanggal = DateTime.Now, Status = 1,Penulis="admin" },
                new KajianVideo{ Link = "https://www.youtube.com/embed/GqCh2wyO_J0", Tanggal = DateTime.Now, Status = 1,Penulis="admin" },
                new KajianVideo{ Link = "https://www.youtube.com/embed/TZCHofmT-jg", Tanggal = DateTime.Now, Status = 1,Penulis="admin" },
                new KajianVideo{ Link = "https://www.youtube.com/embed/FDIU0GCyNqE", Tanggal = DateTime.Now, Status = 1,Penulis="admin" },
                new KajianVideo{ Link = "https://www.youtube.com/embed/S0QswxWoazs", Tanggal = DateTime.Now, Status = 1,Penulis="admin" },
                new KajianVideo{ Link = "https://www.youtube.com/embed/oK0_M5pnpqg", Tanggal = DateTime.Now, Status = 1,Penulis="admin" },
                new KajianVideo{ Link = "https://www.youtube.com/embed/-EVhTEnfEJs", Tanggal = DateTime.Now, Status = 1,Penulis="admin" },
                new KajianVideo{ Link = "https://www.youtube.com/embed/gTpf2BoMZq0", Tanggal = DateTime.Now, Status = 1,Penulis="admin" },
                new KajianVideo{ Link = "https://www.youtube.com/embed/QxbyH80YlZk", Tanggal = DateTime.Now, Status = 1,Penulis="admin" },
                new KajianVideo{ Link = "https://www.youtube.com/embed/wNlUv40LWRQ", Tanggal = DateTime.Now, Status = 1,Penulis="admin" },
                new KajianVideo{ Link = "https://www.youtube.com/embed/oPyR7aKwn_8", Tanggal = DateTime.Now, Status = 1,Penulis="admin" },
                new KajianVideo{ Link = "https://www.youtube.com/embed/BkY3zK14b4k", Tanggal = DateTime.Now, Status = 1,Penulis="admin" },
                new KajianVideo{ Link = "https://www.youtube.com/embed/7KiO2FjOJkU", Tanggal = DateTime.Now, Status = 1,Penulis="admin" },
                new KajianVideo{ Link = "https://www.youtube.com/embed/YleGMu9qILE", Tanggal = DateTime.Now, Status = 1,Penulis="admin" },
                new KajianVideo{ Link = "https://www.youtube.com/embed/4E-oEEvw5G8", Tanggal = DateTime.Now, Status = 1,Penulis="admin" }
            };
            ...
            */
            ...
            foreach (PathKonsultasiEPaper s in pathKonsultasiEPaper)
            {
                ...
                int index = MyString.LastIndexOf(".");
                string JudulString = MyString.Replace(".pdf", "");
                konsultasiEPaper.Add(new KonsultasiEPaper{ Judul = JudulString, Tanggal = DateTime.Now, Path = s, Status = 1, Penulis = "admin" });
            }
            ...
            {
            new KonsultasiRepublika{Judul="Konsultasi Republika",Tanggal = DateTime.Now, Link = "", Status = 1,Penulis="admin"},
            new KonsultasiRepublika{Judul="Konsultasi Republika",Tanggal = DateTime.Now, Link = "", Status = 1,Penulis="admin"}
            };
